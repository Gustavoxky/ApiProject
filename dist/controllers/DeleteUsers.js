...
var DeleteUsers = /** @class */ (function () {
    ...
    DeleteUsers.prototype.handle = function (req, res) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        // Excluir o usuário
                        return [4 /*yield*/, PrismaClient_1.default.users.delete({
                                where: {
                                    name: name
                                }
                            })];
                    ...
                    case 4:
                        error_1 = _a.sent();
                        return [2 /*return*/, res.status(500).json({ error: "Ocorreu um erro ao excluir o usuário" })];
...
//# sourceMappingURL=DeleteUsers.js.map